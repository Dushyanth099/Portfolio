        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <img
              src={myimage}
              alt="Dush image"
              className=" mt-10 p-12 w-70 h-70 dushimage transform translate-y-[-12%]"
              title="Dushyanth"
            />
          </motion.div>
          <motion.div
          ...
          >
            ...
            <p className="text-neutral font-medium text-center translate-y-[-100%] sm:translate-y-[-0%] sm:mb-2 md:text-left">
              ...
              React.js,MongoDB, Express.js, and Node.js to create scalable and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Dushyanth
                Kumar S
              </h2>
              <h2 className="font-medium">
              ...
              <h2 className="font-medium">
                ...
                14/10,Kamarajar Street,Kumaranathapuram,Tirupur-641603
              </h2>
              <a
                href="https://drive.google.com/file/d/1wE2slbC5mN7jbbrzkqVHZJkVlC2ET6se/view?usp=drive_link"
                target="blank"
              >
