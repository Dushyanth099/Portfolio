      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">
              14/10, Kamarajar Street, Kumaranathapuram, Tiruppur-641603
            </h3>
          </div>
          <div className="mt-8 flex items-center">
            ...
            <a
              href="https://linkedin.com/in/dushyanth-kumar-821785300"
              target="blank"
            ...
            <a
              href="https://www.github.com/Dushyanth099"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
            ...
            <a
              href="https://www.instagram.com/___dushh___"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
